...
.controller('AppCtrl', function($scope, $ionicModal, $timeout) {
  ...
  $ionicModal.fromTemplateUrl('templates/reserve.html',{
    ...
    $scope.reservefrom = modal;
  });

  $scope.reserve = function(){
    $scope.reservefrom.show();
  };

  $scope.closeReserve = function() {
    $scope.reservefrom.hide();
  };
  ...
  .controller('FavoritesController',['$scope','dishes','favorites','favoriteFactory','baseURL',
    '$ionicListDelegate','$ionicPopup','$ionicLoading','$timeout', function($scope,dishes,favorites,favoriteFactory,
